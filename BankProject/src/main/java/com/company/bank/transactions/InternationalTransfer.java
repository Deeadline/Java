...
public class InternationalTransfer implements Transfer {
    ...
    public InternationalTransfer(BankAccount[] accounts, Swift[] swifts, int cash, String title) {
        this.firstAccount = accounts[0];
        this.secondAccount = accounts[1];
        this.cash = cash;
        this.title = title;
        this.firstBankSwiftNumber = swifts[0];
        this.secondBankSwiftNumber = swifts[1];
    }
